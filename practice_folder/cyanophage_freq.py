...
input_file = open('\\Users\\19802\\Downloads\\cyanophage.fna', 'r')
...
#formatting stuff! 
output_line = '%s\t%i\t%i\t%i\t%i\t%f\t%s\t%s\n' % \
(gene_name, A_count, C_count, T_count, G_count, gc_value, print('A-',ratio_1),print('Z-',ratio_2))
